...
openapi: 'GET /shared-steps/{sharedStepId}'
noindex: true
---
...
<ResponseField name="steps_by_key" type="object" required>
  ...
  used inside test cases (`goal`, `finish_condition`, `min_seconds`,
  `max_seconds`, `screenshots`, `pause_game`, `performance_monitoring`,
  `hint_manual`).
</ResponseField>
