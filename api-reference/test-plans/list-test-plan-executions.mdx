...
openapi: 'GET /test-plan-executions'
noindex: true
---
...
const response = await fetch(
  "https://nunu.ai/api/v1/test-plan-executions?status=completed&page=0&page_size=10",
  {
    headers: {
...
response = requests.get(
    "https://nunu.ai/api/v1/test-plan-executions",
