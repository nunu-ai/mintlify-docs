...
| [`/runs/export/testrail`](/api-reference/runs/export-testrail) | POST | Export run or test-plan execution results to TestRail |
...
| `project:operate-runs` | Start and stop test runs; export results | Starting tests, stopping runs, exporting to TestRail |
