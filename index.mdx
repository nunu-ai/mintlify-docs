...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="webhook"
    href="/api-reference/webhooks/outbound-webhooks"
  >
    Receive completed test execution payloads in your own systems
  </Card>
</CardGroup>
...
| Topic | Description |
| --- | --- |
| [Outbound webhook payloads](/api-reference/webhooks/outbound-webhooks) | Receive completed test execution results, including multiplayer run state |
